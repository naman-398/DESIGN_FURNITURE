    ...
    return (
        <div className=' bg-[url(../src/Images/herobgimg.webp)]  min-[1200px]:min-h-screen bg-no-repeat bg-cover bg-right lg992:bg-100%' >
            ...
            <div className=' max-w-[1341px] mx-auto px-3 py-[75px] sm:py-[100px] lg992:py-[140px] min-[1200px]:py-[unset]'>
                ...
                <div className=' text-center sm576px:mt-[51px] mt-[30px] '> <Commonbtn padding=' hover:border-[#BE7935] hover:!text-[#FFFFFF] !shadow-[inset_18rem_0_0_0_#BE7935] hover:!bg-[#BE7935] hover:!shadow-[inset_0_0_0_0_#ffffff]' text='SHOP NOW' /></div>
            </div>
        </div>
    )
}
